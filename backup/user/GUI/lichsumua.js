const lichsu = document.getElementById("lichsumua");
...
function drawmyReceipt() {
  lichsu.addEventListener("click", function () {
          ...
          if (dh.tinhTrang === "đã giao hàng") {
            ...
            table.innerHTML = `
              ...
              <tfoot>
                ...
                <tr>
                  <td colspan="6" class="text-center" style="color: green;"><strong>Trạng thái: Đã Giao Hàng</strong></td>
                </tr>
              </tfoot>
            `;
    ...
    if (!hasPendingOrders) {
      ...
      main.innerHTML +=
        '<img src="/backup/Images/anh_rong.png" alt="" style="height: 500px;"><br>';
    }
  });
}
